...
import { IoSearchSharp, IoClipboard } from "react-icons/io5";
  ...
  return (
    <>
      ...
      <header>
        ...
        <div className="bg-zinc shadow overflow-hidden sm:rounded-lg p-32">
          ...
          <div className="border-t border-zinc-200">
            <dl>
              <div className="bg-zinc-800 px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                <dt className="text-sm font-medium text-gray-500">Full name</dt>
                <dd className="mt-1 text-sm text-white-900 sm:mt-0 sm:col-span-2">
                  Margot Foster
                </dd>
              </div>
              <div className="bg-zinc px-4 py-5 sm:grid sm:grid-cols-3 sm:gap-4 sm:px-6">
                  ...
                  >
                    <li className="pl-3 pr-4 py-3 flex items-center justify-between text-sm">
                      <div className="w-0 flex-1 flex items-center">
                        <IoClipboard
                          className="flex-shrink-0 h-5 w-5 text-white-400"
                          aria-hidden="true"
                        />
